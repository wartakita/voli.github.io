    ...
    jwplayer().on('error', function() {
        ...
        jwplayer().on('error', function() {
            ...
            jwplayer().on('error', function() {
                ...
                document.getElementById('player').innerHTML = `<iframe src="${iframeUrl}" width="100%" height="400px" frameborder="0" sandbox="allow-scripts allow-same-origin" allowfullscreen="true"></iframe>`;
            });
        });
    });
