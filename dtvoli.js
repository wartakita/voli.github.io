    ...
    Object.keys(categories).forEach(category => {
        ...
        categories[category].forEach(match => {
            ...
            listItem.innerHTML = `      
                        ...
                        <button class="btn btn-primary btn-sm watch-match" data-video-id="${match.videoId}" data-m3u8="${match.m3u8}" data-mp4="${match.mp4}" data-title="${match.teams}">Watch</button>      
                    `;
